...
public:
	ExampleGame()
	{
		...
		gameEngine->m_Models.emplace_back("E:\\andrea\\FREE_TIME\\CODE\\DROP\\models\\cube.obj");
        gameEngine->m_Models.emplace_back("E:\\andrea\\FREE_TIME\\CODE\\DROP\\models\\sphere.obj");
        gameEngine->m_Models.emplace_back("E:\\andrea\\FREE_TIME\\CODE\\DROP\\models\\bunny_lp.obj");
        gameEngine->m_Models.emplace_back("E:\\andrea\\FREE_TIME\\CODE\\DROP\\models\\plane.obj");

        gameEngine->m_TextureIds.push_back(GameEngine::LoadTexture("E:\\andrea\\FREE_TIME\\CODE\\DROP\\textures\\UV_Grid_Sm.png"));
        gameEngine->m_TextureIds.push_back(GameEngine::LoadTexture("E:\\andrea\\FREE_TIME\\CODE\\DROP\\textures\\SoilCracked.png"));
