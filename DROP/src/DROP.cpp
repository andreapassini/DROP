...
//
//            sceneGraph.nodes[i].CalculateCumulativeTransform();
//            sceneGraph.nodes[i].modelMatrix = glm::mat4(1.0f);
//
//            sceneGraph.nodes[i].modelMatrix = glm::translate(
//                sceneGraph.nodes[i].modelMatrix,
//                glm::vec3(
//                    sceneGraph.nodes[i].cumulativeTransform.translate.x,
//                    sceneGraph.nodes[i].cumulativeTransform.translate.y,
//                    sceneGraph.nodes[i].cumulativeTransform.translate.z
//                )
//            );
//
//            // To be removed
//            glm::vec3 tCumulative(
//                sceneGraph.nodes[i].cumulativeTransform.translate.x,
//                sceneGraph.nodes[i].cumulativeTransform.translate.y,
//                sceneGraph.nodes[i].cumulativeTransform.translate.z
//            );
//            std::cout << "t cumulative: " << tCumulative.x << ", " << tCumulative.y << ", " << tCumulative.z << std::endl;
//            glm::vec3 tLocal(
//                sceneGraph.nodes[i].localTransform.translate.x,
//                sceneGraph.nodes[i].localTransform.translate.y,
//                sceneGraph.nodes[i].localTransform.translate.z
//            );
//            std::cout << "t local: " << tLocal.x << ", " << tLocal.y << ", " << tLocal.z << std::endl;
//            std::cout << "M: " << "\n"
//                << sceneGraph.nodes[i].modelMatrix[0].x << ", " << sceneGraph.nodes[i].modelMatrix[0].y << ", " << sceneGraph.nodes[i].modelMatrix[0].z << "\n"
//                << sceneGraph.nodes[i].modelMatrix[1].x << ", " << sceneGraph.nodes[i].modelMatrix[1].y << ", " << sceneGraph.nodes[i].modelMatrix[1].z << "\n"
//                << sceneGraph.nodes[i].modelMatrix[2].x << ", " << sceneGraph.nodes[i].modelMatrix[2].y << ", " << sceneGraph.nodes[i].modelMatrix[2].z << std::endl;
//
//            sceneGraph.nodes[i].modelMatrix = glm::rotate(
//                sceneGraph.nodes[i].modelMatrix,
//                (float)sceneGraph.nodes[i].cumulativeTransform.rotate.getAngleRadians(),
//                glm::vec3(
//                    (float)sceneGraph.nodes[i].cumulativeTransform.rotate.getAxis().x,
//                    (float)sceneGraph.nodes[i].cumulativeTransform.rotate.getAxis().y,
//                    (float)sceneGraph.nodes[i].cumulativeTransform.rotate.getAxis().z
//                )
//            );
//
//            // To be removed
...
//                (float)sceneGraph.nodes[i].cumulativeTransform.rotate.getAxis().z
//            );
//            std::cout << "r: " << r.x << ", " << r.y << ", " << r.z << "angle: " << (float)sceneGraph.nodes[i].cumulativeTransform.rotate.getAngleRadians() << std::endl;
//            std::cout << "M: " << "\n"
//                << sceneGraph.nodes[i].modelMatrix[0].x << ", " << sceneGraph.nodes[i].modelMatrix[0].y << ", " << sceneGraph.nodes[i].modelMatrix[0].z << "\n"
//                << sceneGraph.nodes[i].modelMatrix[1].x << ", " << sceneGraph.nodes[i].modelMatrix[1].y << ", " << sceneGraph.nodes[i].modelMatrix[1].z << "\n"
//                << sceneGraph.nodes[i].modelMatrix[2].x << ", " << sceneGraph.nodes[i].modelMatrix[2].y << ", " << sceneGraph.nodes[i].modelMatrix[2].z << std::endl;
//
//            sceneGraph.nodes[i].modelMatrix = glm::scale(
//                sceneGraph.nodes[i].modelMatrix,
//#if ANISOTROPIC_SCALING
//                glm::vec3(
//                    (float)sceneGraph.nodes[i].cumulativeTransform.scale.x,
//                    (float)sceneGraph.nodes[i].cumulativeTransform.scale.y,
//                    (float)sceneGraph.nodes[i].cumulativeTransform.scale.z
//                )
//#else
//                glm::vec3(
//                    (float)sceneGraph.nodes[i].cumulativeTransform.scale
//                )
//#endif
//            );
//
//            // To be removed
//            std::cout << "s: " << (float)sceneGraph.nodes[i].cumulativeTransform.scale << std::endl;
//            std::cout << "M: " << "\n"
//                << sceneGraph.nodes[i].modelMatrix[0].x << ", " << sceneGraph.nodes[i].modelMatrix[0].y << ", " << sceneGraph.nodes[i].modelMatrix[0].z << "\n"
//                << sceneGraph.nodes[i].modelMatrix[1].x << ", " << sceneGraph.nodes[i].modelMatrix[1].y << ", " << sceneGraph.nodes[i].modelMatrix[1].z << "\n"
//                << sceneGraph.nodes[i].modelMatrix[2].x << ", " << sceneGraph.nodes[i].modelMatrix[2].y << ", " << sceneGraph.nodes[i].modelMatrix[2].z << "\n" << std::endl;
//
//            if (i == sphereSGHandle) {
//                std::cout << "M: " << "\n"
//                    << sceneGraph.nodes[sphereSGHandle].localTransform.translate.x <<
//                    ", " << sceneGraph.nodes[sphereSGHandle].localTransform.translate.y <<
//                    ", " << sceneGraph.nodes[sphereSGHandle].localTransform.translate.z << std::endl;
//            }
//
