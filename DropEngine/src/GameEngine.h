...
// =================== GAME SIDE ===================
#define GAME_DLL_NAME "DropEngine.dll"
#define GAME_DLL_TEMP_NAME "DropEngine_temp.dll"
#define T_GAME_DLL_NAME TEXT("DropEngine.dll")
#define T_GAME_DLL_TEMP_NAME TEXT("DropEngine_temp.dll")
